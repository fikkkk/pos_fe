...
export default function EditSupplierModal({ isOpen, onClose, onSuccess, supplier }) {
    // Form state
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await api.patch(`/admin/suppliers/${supplier.id}`, payload);

            onSuccess();
            onClose();
        } catch (err) {
            console.error("Error updating supplier:", err);
            const message = err.response?.data?.message || err.message || "Gagal mengupdate supplier.";
            setError(message);
        } finally {
            setLoading(false);
        }
            ...
            <div className="modal-container" onClick={(e) => e.stopPropagation()} style={{ maxWidth: "550px" }}>
                ...
                <form onSubmit={handleSubmit} className="modal-form">
                    ...
                    <div style={{
                        ...
                        📝 Perubahan akan langsung tersimpan ke database setelah Anda klik tombol Simpan.
                    </div>
